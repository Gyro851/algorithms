...
console.log(
  ...
  isCorrectOrderByAbc(['abc', 'cdefz', 'aoaprq'], 'abcdefghijklmnopqrstuvwxyz')
);

console.log(
  'It should return true',
  isCorrectOrderByAbc(['abc', 'cdefz', 'aopqr'], 'abcdefghijklmnopqrstuvwxyz')
);

console.log(
  'It should return true for custom abc',
  isCorrectOrderByAbc(['otaws', 'ots', 'aws'], 'otqaws')
);

console.log(
  'It should return false for custom fedcba',
  isCorrectOrderByAbc(['cbde', 'bdae', 'bbdfd'], 'fedcba')
);
