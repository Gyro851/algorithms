...
[1, 2, 3, 4, 5]
  .reverse()
  .map((el) => (TEST_LINKED_LIST_1.next = new Node(TEST_LINKED_LIST_1.next, el)));

const TEST_LINKED_LIST_2 = new Node(null, -1);
[6, 7, 8, 9, 10]
  .reverse()
  .map((el) => (TEST_LINKED_LIST_2.next = new Node(TEST_LINKED_LIST_2.next, el)));

console.log(
  'It should return merged linked list',
  conmergeTwoLists(TEST_LINKED_LIST_1, TEST_LINKED_LIST_2)
);
